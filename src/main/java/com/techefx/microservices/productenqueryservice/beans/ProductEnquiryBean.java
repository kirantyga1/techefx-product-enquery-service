package com.techefx.microservices.productenqueryservice.beans;
...
public class ProductEnquiryBean {
	...
	public ProductEnquiryBean(Long id, String productName, double productPrice, String productAvailability,
